...
import Placements from "../placement/Placement";
          ...
          <div className="flex-col items-center justify-center hidden w-full my-8 border-2 rounded-md sm:flex nav-light-shadows sm:flex-row">
            ...
            <div className="w-full sm:w-[50%]">
              <div className="m-3 sm:m-4">
                ...
                <h3 className="m-2 md:text-xl lg:text-2xl sm:text-2xl">Campus Placement</h3>
              </div>
              <div className="flex flex-col items-center justify-start p-2 m-2">
                <a target='_blank' rel="noreferrer" href="https://drive.google.com/file/d/1B_AyQS1Si5TPSqsEFqXVvaX3JuvuBrIT/view?usp=sharing" className="w-full font-bold">
                ...
                <Link to='/job-application' className="w-full font-bold">
        ...
        <div className="flex flex-col items-center justify-center w-full my-8 border-2 rounded-md nav-light-shadows">
          ...
          <div className="w-full">
            <div className="m-3">
              ...
              <h3 className="m-2 text-2xl">Campus Placement</h3>
            </div>
            <div className="flex flex-col items-center justify-start p-2 m-2">
